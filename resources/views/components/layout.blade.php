...
<div class="min-h-full">
    <nav class="bg-gray-800">
        <div class="mx-auto max-w-7xl px-4 sm:x-6 lg:px-8">
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">JP Bot</div>
                        <div class="text-sm font-medium text-gray-400">jpbot@gmail.com</div>
                    </div>
                    <button type="button"
